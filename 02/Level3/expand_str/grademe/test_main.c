...
char *capture_program_output(char *input) {
    ...
    if (pid == 0) {
        ...
        if (input) {
            char *args[] = {"./expand_str", input, NULL};
            execv("./expand_str", args);
        } else {
            char *args[] = {"./expand_str", NULL};
            execv("./expand_str", args);
        }
        perror("execv");
        exit(1);
...
int main(void)
{
    ...
    t_test_case tests[] = {
        ...
        {"   ...   ", "...\n",
         "Test puntuación con espacios"},
         
        {"a   b   c", "a   b   c\n",
         "Test espacios ya correctos"},
         
        {"No\tS***\tSherlock...", "No   S***   Sherlock...\n",
         "Test con tabulaciones y puntuación"},
         
        {"  \t  \t  ", "\n",
         "Test solo espacios y tabs"},
        ...
        {"   Hello   ...   World   ", "Hello   ...   World\n",
         "Test espacios inicio, medio y final"},
         
        {"\t\tA\t\tB\t\tC\t\t", "A   B   C\n",
         "Test solo tabs"},
         
        {"     ", "\n",
         "Test múltiples espacios sin palabras"},
        ...
        {"   First  \t  Second\tThird   ", 
         "First   Second   Third\n",
         "Test combinación compleja de espacios y tabs"}
    };
